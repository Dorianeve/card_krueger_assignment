...
```{r eval=T, echo=F, include=T, message=F, warning=F, out.height="80%", out.width="70%"}
...
- tasso occupazione non diminuisce all'aumento del salario minimo
- risultato difference in differences validato con regressione lineare (senza e controlli)
(variabile dipendente cambio tasso occupazione, indipendente stato e variabile GAP)
- vogliamo mettere di QUANTO cambia l'occupazione?
